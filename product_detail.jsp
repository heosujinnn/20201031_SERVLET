            ...
            <div class="container">
                <div class="row">
                    <div class="col-me-6">
                        ...
                        <p><b>상품코드 : </b><span class="badge badge-danger"><%= (product.getProductId() != null) ? product.getProductId() : "" %></span></p>
<p><b>제조사 : </b><%= (product.getManufacturer() != null) ? product.getManufacturer() : "" %></p>
<p><b>분류 : </b><%= (product.getCategory() != null) ? product.getCategory() : "" %></p>
<p><b>재고 수 : </b><%= (product.getUnitsInStock() != 0) ? product.getUnitsInStock() : "" %></p>
<h4><%= (product.getUnitPrice() != null) ? product.getUnitPrice() : "" %>원</h4>
