    ...
    <div class="container">
        <form action="order_info_process.jsp" class="form-horizontal" method="post">
            ...
            <div class="form-group row">
               ...
               <input name="shippingDate" type="date" id="date" max="2077-06-20" value="date">
                    </div></div>
<script>
  // 현재 날짜 가져오기
  let today = new Date();
  ...
  // 'min' 속성을 설정한 후, 해당 값을 'yyyy-mm-dd' 형식으로 변환
        ...
        function openDaumPostcode() {
            new daum.Postcode({
                oncomplete: function(data) {
                    ...
                    document.getElementById('addressName').value = data.roadAddress;
                }
            }).open();
        }
    </script>
